<template>
    <div v-show='{show}' :id='ttpDivid' :class="cssClass">
        <div>
            <span :id='ttpLabelid'>{{labeltext}}</span>
        </div>
        <div>
          <v-tooltip bottom>
            <v-btn fab small color='teal darken-3' slot="activator">
...
export default {
  props: {
    ...
    cssClass: {
      // css classes to use
      type: Array,
      default: () => ['mtooltip', 'mtooltip-static'],
    },
    labeltext: {
      type: String,
  ...
  data() {
    return {
      ...
      //   labeltext: 'toltiptext', // default text of label
    };
  },
  methods: {},
};
